...
<head>
    ...
    <style>
        ...
        .medicine-tests .section {
            width: 48%; /* Adjust width as needed */
        }
        .medicine-tests .section p {
            font-weight: bold;
            text-decoration: underline;
            margin-bottom: 10px;
        }
        .medicine-tests .section div {
            margin-bottom: 5px;
        }
    </style>
</head>
<body>
    <div class="container">
        <div class="header">
            <img class="logo" src="https://www.asterhospitals.in/themes/custom/aster/aster-logo.svg" alt="Aster Hospital Logo" />
            <h1 class="text-2xl font-semibold">Prescription Details</h1>
        </div>
        <div class="details">
